...
export function botResponse(bot: Bot, channel: "Guild" | "Officer", text: string) {
	setTimeout(() => {
		...
		channel == "Guild"
			? bot.memberChannel?.send(text.replaceAll(" | ", "\n"))
...
export async function runCommand(bot: Bot, chat: "Guild" | "Officer", command: string, name: any, args: any) {
	if (commands.api.commands.includes(command) || commands.api.commands.includes(commands.api.aliases[command])) {
					...
					try {
						switch (command) {
							case "cata":
								...
								let cataLevel = getLevel(
									profile["members"][mojangProfile.id]["dungeons"]["dungeon_types"]["catacombs"][
										"experience"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["dungeons"]["dungeon_types"][
												"catacombs"
										  ]["experience"],
									"dungeoneering",
								);
								let archLevel = getLevel(
									profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["archer"][
										"experience"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["archer"][
								...
								let mageLevel = getLevel(
									profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["mage"][
										"experience"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["mage"][
								...
								let tankLevel = getLevel(
									profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["tank"][
										"experience"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["tank"][
								...
								let bersLevel = getLevel(
									profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["berserk"][
										"experience"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["berserk"][
								...
								let healerLevel = getLevel(
									profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["healer"][
										"experience"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["dungeons"]["player_classes"]["healer"][
								...
								botResponse(
									...
									chat,
									`(${
										args != undefined ? args[0] : name
									}) | Cata: ${cataLevel} | Arch: ${archLevel} | Mage: ${mageLevel} | Tank: ${tankLevel} | Bers: ${bersLevel} | Healer: ${healerLevel}`,
								);
								break;
							case "skills":
								const hypixelProfile = await fetchHypixelPlayerProfile(
									args != undefined ? args[0] : name,
								);
								...
								let farmingCap =
									profile["members"][mojangProfile.id]["jacobs_contest"]["perks"][
										"farming_level_cap"
									] == undefined
										? 50
										: 50 +
								...
								let farming = getLevel(
									profile["members"][mojangProfile.id]["player_data"]["experience"][
										"SKILL_FARMING"
									] == undefined
										? 0
										: profile["members"][mojangProfile.id]["player_data"]["experience"][
								...
								let mining = getLevel(
									profile["members"][mojangProfile.id]["player_data"]["experience"]["SKILL_MINING"] ==
										undefined
										? 0
										: profile["members"][mojangProfile.id]["player_data"]["experience"][
												"SKILL_MINING"
								...
								let combat = getLevel(
									profile["members"][mojangProfile.id]["player_data"]["experience"]["SKILL_COMBAT"] ==
										undefined
										? 0
										: profile["members"][mojangProfile.id]["player_data"]["experience"][
												"SKILL_COMBAT"
								...
								let taming = getLevel(
									profile["members"][mojangProfile.id]["player_data"]["experience"]["SKILL_TAMING"] ==
										undefined
										? 0
										: profile["members"][mojangProfile.id]["player_data"]["experience"][
												"SKILL_TAMING"
								...
								let social = getLevel(
									profile["members"][mojangProfile.id]["player_data"]["experience"]["SKILL_SOCIAL"] ==
										undefined
										? 0
										: profile["members"][mojangProfile.id]["player_data"]["experience"][
												"SKILL_SOCIAL"
								...
								botResponse(
									...
									`(${
										args != undefined ? args[0] : name
									}) | Farming: ${farming} | Mining: ${mining} | Foraging: ${foraging} | Combat: ${combat} | Alchemy: ${alchemy} | Carpentry: ${carpentry} | Fishing: ${fishing} | Enchanting: ${enchanting} | Taming: ${taming} | Social: ${social} | Runecrafting: ${runecrafting} | SkillAvg: ${skillAvg.toFixed(
										2,
									)}`,
								);
								break;
							case "slayers":
								...
								let enderman =
									profile["members"][mojangProfile.id]["slayer"]["slayer_bosses"]["enderman"];
								...
								botResponse(
									...
									`(${
										args != undefined ? args[0] : name
									}) | Zombie: ${zombie} | Spider: ${spider} | Wolf: ${wolf} | Enderman: ${enderman} | Blaze: ${blaze} | Vamp: ${vamp}`,
								);
								break;
							case "bank":
								botResponse(
									bot,
									chat,
									`(${args != undefined ? args[0] : name}) | Purse: ${shortenNumber(
										profile["members"][mojangProfile.id]["currencies"]["coin_purse"],
									)} | Bank: ${shortenNumber(profile["banking"]["balance"])}`,
								);
								break;
							case "level":
								botResponse(
									bot,
									chat,
									`(${args != undefined ? args[0] : name}) | Level: ${
							...
							case "networth":
								...
								const networth = await getNetworth(
									profile["members"][mojangProfile.id],
								...
								botResponse(
									bot,
									chat,
									`(${args != undefined ? args[0] : name}) | Networth: ${shortenNumber(
										networth.networth,
									)} | Unsoulbound Networth: ${shortenNumber(networth.unsoulboundNetworth)}`,
								);
								break;
							case "hotm":
								let hotm = getLevel(
									profile["members"][mojangProfile.id]["mining_core"]["experience"],
									"hotm",
								);
								let mithril =
									profile["members"][mojangProfile.id]["mining_core"]["powder_mithril"] +
									profile["members"][mojangProfile.id]["mining_core"]["powder_spent_mithril"];
								let gemstone =
									profile["members"][mojangProfile.id]["mining_core"]["powder_gemstone"] +
									profile["members"][mojangProfile.id]["mining_core"]["powder_spent_gemstone"];
								let glacite =
									profile["members"][mojangProfile.id]["mining_core"]["powder_glacite"] +
									profile["members"][mojangProfile.id]["mining_core"]["powder_spent_glacite"];

								botResponse(
									bot,
									chat,
									`(${args != undefined ? args[0] : name}) | HOTM: ${hotm} | Mithril: ${shortenNumber(
										mithril.toString() == "NaN" ? 0 : mithril,
									)} | Gemstone: ${shortenNumber(
							...
							default:
								botResponse(
									bot,
									chat,
									"Unknown Command although it should exist. If this happens go spam asumji on discord.",
								);
		...
		commands.text.commands.includes(command) ||
		commands.text.commands.includes(commands.text.aliases[command])
	) {
		...
		switch (command) {
			case "mf":
				botResponse(
					bot,
					chat,
					"booster cookie gives 15, community center upgrades gives 5, cake gives 1, scorched power crystal gives 1 + t5 beacon gives 5 and lastly necrons ladder gives 1 (for max 28mf)",
				);
				break;
			case "active":
				botResponse(
